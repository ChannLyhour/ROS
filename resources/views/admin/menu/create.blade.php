...
<div class="p-1 p-md-3">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
        <div>
            <h2 class="fw-semibold mb-0" style="font-size: 1.25rem; color: #212529;">{{ __('New Menu Item') }}</h2>
            <p class="text-muted small mb-0">{{ __('Add a new item to your restaurant menu') }}</p>
        </div>
                        ...
                        <div class="border rounded p-3" style="border-color:#dee2e6 !important; border-radius:6px;">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <div class="form-check form-switch m-0 p-0">
                                    ...
                                    <input type="hidden" name="status" id="statusHidden" value="unavailable" disabled>
                                </div>
                            </div>
                            <span id="statusBadge" class="status-badge available d-flex align-items-center justify-content-center gap-2 py-2">
                                <span class="status-dot"></span> {{ __('Available') }}
                            </span>
                        </div>

                        <div class="mt-3 p-3 bg-light border rounded small text-muted" style="border-color:#dee2e6 !important; border-radius:6px;">
                            <div class="d-flex gap-2">
                                <i data-lucide="info" class="text-primary flex-shrink-0" style="width:15px;margin-top:2px;"></i>
                                <span>{{ __('High-quality images with neutral backgrounds work best in digital menus.') }}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" rows="6"
                                      ...
                                      placeholder="{{ __('Describe ingredients, taste, and presentation...') }}">{{ old('description') }}</textarea>
