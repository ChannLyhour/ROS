...
<div class="p-1 p-md-3">
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
        <div>
            <h2 class="fw-semibold mb-0" style="font-size:1.25rem; color:#212529;">{{ __('Edit Staff Member') }}</h2>
            <p class="text-muted small mb-0">{{ __('Editing') }}: <strong>{{ $user->name }}</strong></p>
        </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="d-flex align-items-center gap-2 mb-3">
                                    ...
                                    <span class="fw-semibold small text-dark">{{ __('Change Password') }}</span>
                                    <span class="text-muted" style="font-size:0.75rem;">{{ __('(leave blank to keep current)') }}</span>
                                </div>
                            </div>
                            <div class="col-md-6">
