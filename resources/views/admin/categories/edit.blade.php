...
<div class="category-page p-1 p-md-3">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
        <div class="flex-grow-1">
            <h2 class="fw-semibold mb-0" style="font-size: 1.25rem; color: #212529;">{{ __('Edit Category') }}: {{ $category->name }}</h2>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description"
                                ...
                                rows="4"
                                placeholder="{{ __('Briefly describe what items fall under this category...') }}">{{ old('description', $category->description) }}</textarea>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="border rounded p-3" style="border-color: #dee2e6 !important;">
                            ...
                            <div id="statusBadgeWrap">
                                ...
                                @else
                                <span id="statusBadge" class="badge bg-secondary-subtle text-secondary d-flex align-items-center gap-1 justify-content-center py-2">
                                    <i data-lucide="eye-off" style="width: 13px;"></i> {{ __('Hidden / Disabled') }}
                                </span>
                                @endif
                            </div>
                        </div>
