...
<div class="p-1 p-md-3">
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
        <div>
            <h2 class="fw-semibold mb-0" style="font-size:1.25rem; color:#212529;">{{ __('Edit Table') }}</h2>
            <p class="text-muted small mb-0">{{ __('Editing') }}: <strong>{{ $table->name }}</strong></p>
        </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="p-3 bg-light border rounded small text-muted" style="border-color:#dee2e6 !important; border-radius:6px;">
                            <div class="d-flex gap-2">
                                ...
                                <span>{{ __('Status changes reflect immediately on the floor map.') }}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name"
                                   ...
                                   placeholder="{{ __('e.g. VIP-01') }}" required>
